...
printf(int fd, const char *fmt, ...)
{
 ...
 594:	eb 1a                	jmp    5b0 <printf+0x1a0>
          s = "(null)";
 596:	bb b8 07 00 00       	mov    $0x7b8,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5e5:	a1 68 0a 00 00       	mov    0xa68,%eax
{
 ...
 606:	73 10                	jae    618 <free+0x38>
{
 ...
 631:	5b                   	pop    %ebx
  freep = p;
 632:	a3 68 0a 00 00       	mov    %eax,0xa68
}
 637:	5e                   	pop    %esi
 638:	5f                   	pop    %edi
 639:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 67d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 680:	8b 3d 68 0a 00 00    	mov    0xa68,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6c9:	8b 3d 68 0a 00 00    	mov    0xa68,%edi
 ...
 6f2:	e8 e9 fe ff ff       	call   5e0 <free>
  return freep;
 6f7:	a1 68 0a 00 00       	mov    0xa68,%eax
 ...
 724:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 727:	a3 68 0a 00 00       	mov    %eax,0xa68
}
 ...
 747:	0a 00 00 
    base.s.size = 0;
 74a:	bf 6c 0a 00 00       	mov    $0xa6c,%edi
    base.s.ptr = freep = prevp = &base;
 74f:	c7 05 6c 0a 00 00 6c 	movl   $0xa6c,0xa6c
 756:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 759:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 75b:	c7 05 70 0a 00 00 00 	movl   $0x0,0xa70
 762:	00 00 00 
    if(p->s.size >= nunits){
