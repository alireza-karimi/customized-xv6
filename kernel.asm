...
801037dc:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
801037e2:	e8 89 0e 00 00       	call   80104670 <release>
...
80103804:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103807:	c7 40 14 1c 59 10 80 	movl   $0x8010591c,0x14(%eax)
  p->context = (struct context*)sp;
...
80103816:	e8 a5 0e 00 00       	call   801046c0 <memset>
...
8010383a:	e8 31 0e 00 00       	call   80104670 <release>
}
...
8010386f:	e8 fc 0d 00 00       	call   80104670 <release>
...
801038c4:	e8 67 0b 00 00       	call   80104430 <initlock>
}
...
80103968:	83 ec 04             	sub    $0x4,%esp
  pushcli();
8010396b:	e8 40 0b 00 00       	call   801044b0 <pushcli>
  c = mycpu();
80103970:	e8 5b ff ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103975:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010397b:	e8 80 0b 00 00       	call   80104500 <popcli>
}
...
801039da:	e8 e1 0c 00 00       	call   801046c0 <memset>
...
80103a39:	e8 42 0e 00 00       	call   80104880 <safestrcpy>
  p->cwd = namei("/");
...
80103a99:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103a9c:	e8 0f 0a 00 00       	call   801044b0 <pushcli>
  c = mycpu();
80103aa1:	e8 2a fe ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103aa6:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103aac:	e8 4f 0a 00 00       	call   80104500 <popcli>
  sz = curproc->sz;
...
80103b1a:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b1d:	e8 8e 09 00 00       	call   801044b0 <pushcli>
  c = mycpu();
80103b22:	e8 a9 fd ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103b27:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b2d:	e8 ce 09 00 00       	call   80104500 <popcli>
  if((np = allocproc()) == 0){
...
80103c66:	e8 45 09 00 00       	call   801045b0 <acquire>
...
80103c8b:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103c92:	e8 4c 0c 00 00       	call   801048e3 <swtch>
      switchkvm();
...
80103cbc:	e8 af 09 00 00       	call   80104670 <release>
    sti();
...
80103cd8:	53                   	push   %ebx
  pushcli();
80103cd9:	e8 d2 07 00 00       	call   801044b0 <pushcli>
  c = mycpu();
...
80103cf6:	e8 65 08 00 00       	call   80104560 <holding>
...
80103d37:	e8 a7 0b 00 00       	call   801048e3 <swtch>
  mycpu()->intena = intena;
...
80103d9a:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103d9d:	e8 0e 07 00 00       	call   801044b0 <pushcli>
  c = mycpu();
80103da2:	e8 29 fb ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103da7:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103dad:	e8 4e 07 00 00       	call   80104500 <popcli>
  if(curproc == initproc)
...
80103ee0:	e8 cb 06 00 00       	call   801045b0 <acquire>
  pushcli();
80103ee5:	e8 c6 05 00 00       	call   801044b0 <pushcli>
  c = mycpu();
80103eea:	e8 e1 f9 ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103eef:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ef5:	e8 06 06 00 00       	call   80104500 <popcli>
...
80103f0d:	e8 5e 07 00 00       	call   80104670 <release>
}
...
80103f30:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103f33:	e8 78 05 00 00       	call   801044b0 <pushcli>
  c = mycpu();
80103f38:	e8 93 f9 ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103f3d:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f43:	e8 b8 05 00 00       	call   80104500 <popcli>
  if(p == 0)
...
80103f64:	e8 47 06 00 00       	call   801045b0 <acquire>
    release(lk);
80103f69:	89 34 24             	mov    %esi,(%esp)
80103f6c:	e8 ff 06 00 00       	call   80104670 <release>
  p->chan = chan;
...
80103f8e:	e8 dd 06 00 00       	call   80104670 <release>
    acquire(lk);
...
80103f9f:	5d                   	pop    %ebp
    acquire(lk);
80103fa0:	e9 0b 06 00 00       	jmp    801045b0 <acquire>
...
801040a6:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
801040ad:	e8 be 05 00 00       	call   80104670 <release>
        return pid;
...
801040cb:	e8 a0 05 00 00       	call   80104670 <release>
      return -1;
...
801040f3:	e8 b8 04 00 00       	call   801045b0 <acquire>
...
80104138:	c9                   	leave  
  release(&ptable.lock);
80104139:	e9 32 05 00 00       	jmp    80104670 <release>
...
80104153:	e8 58 04 00 00       	call   801045b0 <acquire>
...
80104193:	e8 d8 04 00 00       	call   80104670 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
801041b0:	e8 bb 04 00 00       	call   80104670 <release>
}
...
80104203:	81 fb e0 4d 11 80    	cmp    $0x80114de0,%ebx
...
8010425d:	e8 ee 01 00 00       	call   80104450 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
801042a7:	53                   	push   %ebx
  ...
  acquire(&ptable.lock);
  int count = 0;
801042a8:	31 db                	xor    %ebx,%ebx
{
801042aa:	83 ec 10             	sub    $0x10,%esp
  acquire(&ptable.lock);
801042ad:	68 40 2d 11 80       	push   $0x80112d40
801042b2:	e8 f9 02 00 00       	call   801045b0 <acquire>
801042b7:	83 c4 10             	add    $0x10,%esp
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801042ba:	b8 74 2d 11 80       	mov    $0x80112d74,%eax
801042bf:	90                   	nop
  {
    if (p->state != UNUSED)
    {
...
801042c4:	83 db ff             	sbb    $0xffffffff,%ebx
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801042c7:	83 e8 80             	sub    $0xffffff80,%eax
801042ca:	3d 74 4d 11 80       	cmp    $0x80114d74,%eax
801042cf:	75 ef                	jne    801042c0 <getProcCount+0x20>
    }
  }
  release(&ptable.lock);
801042d1:	83 ec 0c             	sub    $0xc,%esp
801042d4:	68 40 2d 11 80       	push   $0x80112d40
...
801042fe:	68 e4 77 10 80       	push   $0x801077e4
...
8010435d:	e8 be fb ff ff       	call   80103f20 <sleep>
  while (lk->locked) {
...
8010436b:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104371:	e8 ea f5 ff ff       	call   80103960 <myproc>
...
801043b8:	e8 23 fd ff ff       	call   801040e0 <wakeup>
  release(&lk->lk);
...
8010452f:	c3                   	ret    
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104530:	e8 9b f3 ff ff       	call   801038d0 <mycpu>
...
80104545:	68 ef 77 10 80       	push   $0x801077ef
8010454a:	e8 41 be ff ff       	call   80100390 <panic>
    panic("popcli");
8010454f:	83 ec 0c             	sub    $0xc,%esp
80104552:	68 06 78 10 80       	push   $0x80107806
...
8010458b:	e8 40 f3 ff ff       	call   801038d0 <mycpu>
...
801045f4:	e8 d7 f2 ff ff       	call   801038d0 <mycpu>
...
80104657:	68 0d 78 10 80       	push   $0x8010780d
...
801046b0:	68 15 78 10 80       	push   $0x80107815
...
801049fc:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
801049ff:	e8 5c ef ff ff       	call   80103960 <myproc>
...
80104a98:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104a9b:	e8 c0 ee ff ff       	call   80103960 <myproc>
...
80104aab:	74 5b                	je     80104b08 <syscall+0x78>
    readcount++;
  }
  if(num == SYS_getReadCount){
80104aad:	83 f8 17             	cmp    $0x17,%eax
80104ab0:	75 26                	jne    80104ad8 <syscall+0x48>
    curproc->readid = readcount;
80104ab2:	8b 15 bc a5 10 80    	mov    0x8010a5bc,%edx
80104ab8:	89 53 7c             	mov    %edx,0x7c(%ebx)
  }
  //
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104abb:	8b 14 85 40 78 10 80 	mov    -0x7fef87c0(,%eax,4),%edx
    curproc->tf->eax = syscalls[num]();
80104ac2:	ff d2                	call   *%edx
80104ac4:	89 c2                	mov    %eax,%edx
80104ac6:	8b 43 18             	mov    0x18(%ebx),%eax
80104ac9:	89 50 1c             	mov    %edx,0x1c(%eax)
  } else {
...
80104acc:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104acf:	c9                   	leave  
80104ad0:	c3                   	ret    
...
80104ade:	76 31                	jbe    80104b11 <syscall+0x81>
    cprintf("%d %s: unknown sys call %d\n",
...
80104b04:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    readcount++;
80104b08:	83 05 bc a5 10 80 01 	addl   $0x1,0x8010a5bc
  if(num == SYS_getReadCount){
80104b0f:	eb aa                	jmp    80104abb <syscall+0x2b>
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104b11:	8b 14 85 40 78 10 80 	mov    -0x7fef87c0(,%eax,4),%edx
80104b18:	85 d2                	test   %edx,%edx
80104b1a:	74 c4                	je     80104ae0 <syscall+0x50>
80104b1c:	eb a4                	jmp    80104ac2 <syscall+0x32>
...
80104c54:	68 bc 78 10 80       	push   $0x801078bc
...
80104c6c:	68 bb 78 10 80       	push   $0x801078bb
...
80104c81:	68 af 78 10 80       	push   $0x801078af
...
80104c9f:	68 be 78 10 80       	push   $0x801078be
80104ca4:	e8 e7 b6 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104ca9:	83 ec 0c             	sub    $0xc,%esp
80104cac:	68 a0 78 10 80       	push   $0x801078a0
...
80104da1:	e8 fa fb ff ff       	call   801049a0 <argint>
...
80104db9:	e8 32 fc ff ff       	call   801049f0 <argptr>
...
80104e11:	e8 8a fb ff ff       	call   801049a0 <argint>
...
80104e29:	e8 c2 fb ff ff       	call   801049f0 <argptr>
...
80104ed3:	e8 18 fb ff ff       	call   801049f0 <argptr>
...
80104f13:	e8 38 fb ff ff       	call   80104a50 <argstr>
...
80104f2c:	e8 1f fb ff ff       	call   80104a50 <argstr>
...
80105063:	e8 e8 f9 ff ff       	call   80104a50 <argstr>
...
8010509d:	58                   	pop    %eax
8010509e:	5a                   	pop    %edx
8010509f:	68 bc 78 10 80       	push   $0x801078bc
...
801050b8:	68 bb 78 10 80       	push   $0x801078bb
...
80105112:	e8 a9 f5 ff ff       	call   801046c0 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
80105243:	e8 08 f8 ff ff       	call   80104a50 <argstr>
...
8010525c:	e8 3f f7 ff ff       	call   801049a0 <argint>
...
80105388:	e8 c3 f6 ff ff       	call   80104a50 <argstr>
...
801053f8:	e8 53 f6 ff ff       	call   80104a50 <argstr>
...
8010540d:	e8 8e f5 ff ff       	call   801049a0 <argint>
  if((argstr(0, &path)) < 0 ||
...
80105422:	e8 79 f5 ff ff       	call   801049a0 <argint>
     argint(1, &major) < 0 ||
...
801054a1:	e8 aa f5 ff ff       	call   80104a50 <argstr>
...
80105549:	e8 02 f5 ff ff       	call   80104a50 <argstr>
...
80105565:	e8 36 f4 ff ff       	call   801049a0 <argint>
...
8010558a:	e8 31 f1 ff ff       	call   801046c0 <memset>
...
801055ac:	e8 4f f3 ff ff       	call   80104900 <fetchint>
...
801055d0:	e8 6b f3 ff ff       	call   80104940 <fetchstr>
...
80105645:	e8 a6 f3 ff ff       	call   801049f0 <argptr>
...
80105760:	e8 3b f2 ff ff       	call   801049a0 <argint>
...
801057c1:	e8 da f1 ff ff       	call   801049a0 <argint>
...
80105811:	e8 8a f1 ff ff       	call   801049a0 <argint>
...
80105824:	68 80 4d 11 80       	push   $0x80114d80
80105829:	e8 82 ed ff ff       	call   801045b0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010582e:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105831:	8b 1d c0 55 11 80    	mov    0x801155c0,%ebx
  while(ticks - ticks0 < n){
...
80105843:	68 80 4d 11 80       	push   $0x80114d80
80105848:	68 c0 55 11 80       	push   $0x801155c0
8010584d:	e8 ce e6 ff ff       	call   80103f20 <sleep>
  while(ticks - ticks0 < n){
80105852:	a1 c0 55 11 80       	mov    0x801155c0,%eax
...
80105870:	68 80 4d 11 80       	push   $0x80114d80
80105875:	e8 f6 ed ff ff       	call   80104670 <release>
  }
  release(&tickslock);
  return 0;
}
...
80105893:	68 80 4d 11 80       	push   $0x80114d80
80105898:	e8 d3 ed ff ff       	call   80104670 <release>
  return 0;
...
801058b8:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801058bb:	68 80 4d 11 80       	push   $0x80114d80
801058c0:	e8 eb ec ff ff       	call   801045b0 <acquire>
  xticks = ticks;
801058c5:	8b 1d c0 55 11 80    	mov    0x801155c0,%ebx
  release(&tickslock);
801058cb:	c7 04 24 80 4d 11 80 	movl   $0x80114d80,(%esp)
801058d2:	e8 99 ed ff ff       	call   80104670 <release>
  return xticks;
}
...
801058e0:	f3 0f 1e fb          	endbr32 
  return getProcCount();
801058e4:	e9 b7 e9 ff ff       	jmp    801042a0 <getProcCount>
801058e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

801058f0 <sys_getReadCount>:
}
...
801058ff:	8b 40 7c             	mov    0x7c(%eax),%eax
80105902:	c9                   	leave  
80105903:	c3                   	ret    
...
80105905:	06                   	push   %es
  pushl %fs
80105906:	0f a0                	push   %fs
  pushl %gs
80105908:	0f a8                	push   %gs
  pushal
8010590a:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
8010590b:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
8010590f:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105911:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105913:	54                   	push   %esp
  call trap
80105914:	e8 c7 00 00 00       	call   801059e0 <trap>
  addl $4, %esp
80105919:	83 c4 04             	add    $0x4,%esp
...
8010591c:	61                   	popa   
  popl %gs
8010591d:	0f a9                	pop    %gs
  popl %fs
8010591f:	0f a1                	pop    %fs
  popl %es
80105921:	07                   	pop    %es
  popl %ds
80105922:	1f                   	pop    %ds
...
80105947:	c7 04 c5 c2 4d 11 80 	movl   $0x8e000008,-0x7feeb23e(,%eax,8)
8010594e:	08 00 00 8e 
80105952:	66 89 14 c5 c0 4d 11 	mov    %dx,-0x7feeb240(,%eax,8)
80105959:	80 
8010595a:	c1 ea 10             	shr    $0x10,%edx
8010595d:	66 89 14 c5 c6 4d 11 	mov    %dx,-0x7feeb23a(,%eax,8)
80105964:	80 
  for(i = 0; i < 256; i++)
...
80105977:	c7 05 c2 4f 11 80 08 	movl   $0xef000008,0x80114fc2
8010597e:	00 00 ef 
  initlock(&tickslock, "time");
80105981:	68 01 79 10 80       	push   $0x80107901
80105986:	68 80 4d 11 80       	push   $0x80114d80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010598b:	66 a3 c0 4f 11 80    	mov    %ax,0x80114fc0
80105991:	c1 e8 10             	shr    $0x10,%eax
80105994:	66 a3 c6 4f 11 80    	mov    %ax,0x80114fc6
  initlock(&tickslock, "time");
...
801059bf:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801059c3:	b8 c0 4d 11 80       	mov    $0x80114dc0,%eax
...
80105a04:	3e ff 24 85 a8 79 10 	notrack jmp *-0x7fef8658(,%eax,4)
80105a0b:	80 
    lapiceoi();
    break;
...
80105a61:	68 64 79 10 80       	push   $0x80107964
...
80105b07:	68 80 4d 11 80       	push   $0x80114d80
80105b0c:	e8 9f ea ff ff       	call   801045b0 <acquire>
      wakeup(&ticks);
80105b11:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
      ticks++;
80105b18:	83 05 c0 55 11 80 01 	addl   $0x1,0x801155c0
      wakeup(&ticks);
80105b1f:	e8 bc e5 ff ff       	call   801040e0 <wakeup>
      release(&tickslock);
80105b24:	c7 04 24 80 4d 11 80 	movl   $0x80114d80,(%esp)
80105b2b:	e8 40 eb ff ff       	call   80104670 <release>
...
80105b7c:	68 0c 79 10 80       	push   $0x8010790c
...
80105bc9:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105bcc:	e8 bf ee ff ff       	call   80104a90 <syscall>
    if(myproc()->killed)
...
80105c18:	68 30 79 10 80       	push   $0x80107930
80105c1d:	e8 8e aa ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105c22:	83 c4 14             	add    $0x14,%esp
80105c25:	68 06 79 10 80       	push   $0x80107906
...
80105c30:	f3 0f 1e fb          	endbr32 
  if(!uart)
80105c34:	a1 c0 a5 10 80       	mov    0x8010a5c0,%eax
...
80105d0b:	74 52                	je     80105d5f <uartinit+0xaf>
  uart = 1;
80105d0d:	c7 05 c0 a5 10 80 01 	movl   $0x1,0x8010a5c0
80105d14:	00 00 00 
...
80105d23:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80105d28:	bb 28 7a 10 80       	mov    $0x80107a28,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105d40:	0f b6 73 01          	movzbl 0x1(%ebx),%esi
  if(!uart)
80105d44:	8b 15 c0 a5 10 80    	mov    0x8010a5c0,%edx
...
80105d74:	55                   	push   %ebp
  if(!uart)
80105d75:	8b 15 c0 a5 10 80    	mov    0x8010a5c0,%edx
{
...
80105dbb:	6a 00                	push   $0x0
  jmp alltraps
80105dbd:	e9 42 fb ff ff       	jmp    80105904 <alltraps>
...
80105dc4:	6a 01                	push   $0x1
  jmp alltraps
80105dc6:	e9 39 fb ff ff       	jmp    80105904 <alltraps>
...
80105dcd:	6a 02                	push   $0x2
  jmp alltraps
80105dcf:	e9 30 fb ff ff       	jmp    80105904 <alltraps>
...
80105dd6:	6a 03                	push   $0x3
  jmp alltraps
80105dd8:	e9 27 fb ff ff       	jmp    80105904 <alltraps>
...
80105ddf:	6a 04                	push   $0x4
  jmp alltraps
80105de1:	e9 1e fb ff ff       	jmp    80105904 <alltraps>
...
80105de8:	6a 05                	push   $0x5
  jmp alltraps
80105dea:	e9 15 fb ff ff       	jmp    80105904 <alltraps>
...
80105df1:	6a 06                	push   $0x6
  jmp alltraps
80105df3:	e9 0c fb ff ff       	jmp    80105904 <alltraps>
...
80105dfa:	6a 07                	push   $0x7
  jmp alltraps
80105dfc:	e9 03 fb ff ff       	jmp    80105904 <alltraps>
...
80105e01:	6a 08                	push   $0x8
  jmp alltraps
80105e03:	e9 fc fa ff ff       	jmp    80105904 <alltraps>
...
80105e0a:	6a 09                	push   $0x9
  jmp alltraps
80105e0c:	e9 f3 fa ff ff       	jmp    80105904 <alltraps>
...
80105e11:	6a 0a                	push   $0xa
  jmp alltraps
80105e13:	e9 ec fa ff ff       	jmp    80105904 <alltraps>
...
80105e18:	6a 0b                	push   $0xb
  jmp alltraps
80105e1a:	e9 e5 fa ff ff       	jmp    80105904 <alltraps>
...
80105e1f:	6a 0c                	push   $0xc
  jmp alltraps
80105e21:	e9 de fa ff ff       	jmp    80105904 <alltraps>
...
80105e26:	6a 0d                	push   $0xd
  jmp alltraps
80105e28:	e9 d7 fa ff ff       	jmp    80105904 <alltraps>
...
80105e2d:	6a 0e                	push   $0xe
  jmp alltraps
80105e2f:	e9 d0 fa ff ff       	jmp    80105904 <alltraps>
...
80105e36:	6a 0f                	push   $0xf
  jmp alltraps
80105e38:	e9 c7 fa ff ff       	jmp    80105904 <alltraps>
...
80105e3f:	6a 10                	push   $0x10
  jmp alltraps
80105e41:	e9 be fa ff ff       	jmp    80105904 <alltraps>
...
80105e46:	6a 11                	push   $0x11
  jmp alltraps
80105e48:	e9 b7 fa ff ff       	jmp    80105904 <alltraps>
...
80105e4f:	6a 12                	push   $0x12
  jmp alltraps
80105e51:	e9 ae fa ff ff       	jmp    80105904 <alltraps>
...
80105e58:	6a 13                	push   $0x13
  jmp alltraps
80105e5a:	e9 a5 fa ff ff       	jmp    80105904 <alltraps>
...
80105e61:	6a 14                	push   $0x14
  jmp alltraps
80105e63:	e9 9c fa ff ff       	jmp    80105904 <alltraps>
...
80105e6a:	6a 15                	push   $0x15
  jmp alltraps
80105e6c:	e9 93 fa ff ff       	jmp    80105904 <alltraps>
...
80105e73:	6a 16                	push   $0x16
  jmp alltraps
80105e75:	e9 8a fa ff ff       	jmp    80105904 <alltraps>
...
80105e7c:	6a 17                	push   $0x17
  jmp alltraps
80105e7e:	e9 81 fa ff ff       	jmp    80105904 <alltraps>
...
80105e85:	6a 18                	push   $0x18
  jmp alltraps
80105e87:	e9 78 fa ff ff       	jmp    80105904 <alltraps>
...
80105e8e:	6a 19                	push   $0x19
  jmp alltraps
80105e90:	e9 6f fa ff ff       	jmp    80105904 <alltraps>
...
80105e97:	6a 1a                	push   $0x1a
  jmp alltraps
80105e99:	e9 66 fa ff ff       	jmp    80105904 <alltraps>
...
80105ea0:	6a 1b                	push   $0x1b
  jmp alltraps
80105ea2:	e9 5d fa ff ff       	jmp    80105904 <alltraps>
...
80105ea9:	6a 1c                	push   $0x1c
  jmp alltraps
80105eab:	e9 54 fa ff ff       	jmp    80105904 <alltraps>
...
80105eb2:	6a 1d                	push   $0x1d
  jmp alltraps
80105eb4:	e9 4b fa ff ff       	jmp    80105904 <alltraps>
...
80105ebb:	6a 1e                	push   $0x1e
  jmp alltraps
80105ebd:	e9 42 fa ff ff       	jmp    80105904 <alltraps>
...
80105ec4:	6a 1f                	push   $0x1f
  jmp alltraps
80105ec6:	e9 39 fa ff ff       	jmp    80105904 <alltraps>
...
80105ecd:	6a 20                	push   $0x20
  jmp alltraps
80105ecf:	e9 30 fa ff ff       	jmp    80105904 <alltraps>
...
80105ed6:	6a 21                	push   $0x21
  jmp alltraps
80105ed8:	e9 27 fa ff ff       	jmp    80105904 <alltraps>
...
80105edf:	6a 22                	push   $0x22
  jmp alltraps
80105ee1:	e9 1e fa ff ff       	jmp    80105904 <alltraps>
...
80105ee8:	6a 23                	push   $0x23
  jmp alltraps
80105eea:	e9 15 fa ff ff       	jmp    80105904 <alltraps>
...
80105ef1:	6a 24                	push   $0x24
  jmp alltraps
80105ef3:	e9 0c fa ff ff       	jmp    80105904 <alltraps>
...
80105efa:	6a 25                	push   $0x25
  jmp alltraps
80105efc:	e9 03 fa ff ff       	jmp    80105904 <alltraps>
...
80105f03:	6a 26                	push   $0x26
  jmp alltraps
80105f05:	e9 fa f9 ff ff       	jmp    80105904 <alltraps>
...
80105f0c:	6a 27                	push   $0x27
  jmp alltraps
80105f0e:	e9 f1 f9 ff ff       	jmp    80105904 <alltraps>
...
80105f15:	6a 28                	push   $0x28
  jmp alltraps
80105f17:	e9 e8 f9 ff ff       	jmp    80105904 <alltraps>
...
80105f1e:	6a 29                	push   $0x29
  jmp alltraps
80105f20:	e9 df f9 ff ff       	jmp    80105904 <alltraps>
...
80105f27:	6a 2a                	push   $0x2a
  jmp alltraps
80105f29:	e9 d6 f9 ff ff       	jmp    80105904 <alltraps>
...
80105f30:	6a 2b                	push   $0x2b
  jmp alltraps
80105f32:	e9 cd f9 ff ff       	jmp    80105904 <alltraps>
...
80105f39:	6a 2c                	push   $0x2c
  jmp alltraps
80105f3b:	e9 c4 f9 ff ff       	jmp    80105904 <alltraps>
...
80105f42:	6a 2d                	push   $0x2d
  jmp alltraps
80105f44:	e9 bb f9 ff ff       	jmp    80105904 <alltraps>
...
80105f4b:	6a 2e                	push   $0x2e
  jmp alltraps
80105f4d:	e9 b2 f9 ff ff       	jmp    80105904 <alltraps>
...
80105f54:	6a 2f                	push   $0x2f
  jmp alltraps
80105f56:	e9 a9 f9 ff ff       	jmp    80105904 <alltraps>
...
80105f5d:	6a 30                	push   $0x30
  jmp alltraps
80105f5f:	e9 a0 f9 ff ff       	jmp    80105904 <alltraps>
...
80105f66:	6a 31                	push   $0x31
  jmp alltraps
80105f68:	e9 97 f9 ff ff       	jmp    80105904 <alltraps>
...
80105f6f:	6a 32                	push   $0x32
  jmp alltraps
80105f71:	e9 8e f9 ff ff       	jmp    80105904 <alltraps>
...
80105f78:	6a 33                	push   $0x33
  jmp alltraps
80105f7a:	e9 85 f9 ff ff       	jmp    80105904 <alltraps>
...
80105f81:	6a 34                	push   $0x34
  jmp alltraps
80105f83:	e9 7c f9 ff ff       	jmp    80105904 <alltraps>
...
80105f8a:	6a 35                	push   $0x35
  jmp alltraps
80105f8c:	e9 73 f9 ff ff       	jmp    80105904 <alltraps>
...
80105f93:	6a 36                	push   $0x36
  jmp alltraps
80105f95:	e9 6a f9 ff ff       	jmp    80105904 <alltraps>
...
80105f9c:	6a 37                	push   $0x37
  jmp alltraps
80105f9e:	e9 61 f9 ff ff       	jmp    80105904 <alltraps>
...
80105fa5:	6a 38                	push   $0x38
  jmp alltraps
80105fa7:	e9 58 f9 ff ff       	jmp    80105904 <alltraps>
...
80105fae:	6a 39                	push   $0x39
  jmp alltraps
80105fb0:	e9 4f f9 ff ff       	jmp    80105904 <alltraps>
...
80105fb7:	6a 3a                	push   $0x3a
  jmp alltraps
80105fb9:	e9 46 f9 ff ff       	jmp    80105904 <alltraps>
...
80105fc0:	6a 3b                	push   $0x3b
  jmp alltraps
80105fc2:	e9 3d f9 ff ff       	jmp    80105904 <alltraps>
...
80105fc9:	6a 3c                	push   $0x3c
  jmp alltraps
80105fcb:	e9 34 f9 ff ff       	jmp    80105904 <alltraps>
...
80105fd2:	6a 3d                	push   $0x3d
  jmp alltraps
80105fd4:	e9 2b f9 ff ff       	jmp    80105904 <alltraps>
...
80105fdb:	6a 3e                	push   $0x3e
  jmp alltraps
80105fdd:	e9 22 f9 ff ff       	jmp    80105904 <alltraps>
...
80105fe4:	6a 3f                	push   $0x3f
  jmp alltraps
80105fe6:	e9 19 f9 ff ff       	jmp    80105904 <alltraps>
...
80105fed:	6a 40                	push   $0x40
  jmp alltraps
80105fef:	e9 10 f9 ff ff       	jmp    80105904 <alltraps>
...
80105ff6:	6a 41                	push   $0x41
  jmp alltraps
80105ff8:	e9 07 f9 ff ff       	jmp    80105904 <alltraps>
...
80105fff:	6a 42                	push   $0x42
  jmp alltraps
80106001:	e9 fe f8 ff ff       	jmp    80105904 <alltraps>
...
80106008:	6a 43                	push   $0x43
  jmp alltraps
8010600a:	e9 f5 f8 ff ff       	jmp    80105904 <alltraps>
...
80106011:	6a 44                	push   $0x44
  jmp alltraps
80106013:	e9 ec f8 ff ff       	jmp    80105904 <alltraps>
...
8010601a:	6a 45                	push   $0x45
  jmp alltraps
8010601c:	e9 e3 f8 ff ff       	jmp    80105904 <alltraps>
...
80106023:	6a 46                	push   $0x46
  jmp alltraps
80106025:	e9 da f8 ff ff       	jmp    80105904 <alltraps>
...
8010602c:	6a 47                	push   $0x47
  jmp alltraps
8010602e:	e9 d1 f8 ff ff       	jmp    80105904 <alltraps>
...
80106035:	6a 48                	push   $0x48
  jmp alltraps
80106037:	e9 c8 f8 ff ff       	jmp    80105904 <alltraps>
...
8010603e:	6a 49                	push   $0x49
  jmp alltraps
80106040:	e9 bf f8 ff ff       	jmp    80105904 <alltraps>
...
80106047:	6a 4a                	push   $0x4a
  jmp alltraps
80106049:	e9 b6 f8 ff ff       	jmp    80105904 <alltraps>
...
80106050:	6a 4b                	push   $0x4b
  jmp alltraps
80106052:	e9 ad f8 ff ff       	jmp    80105904 <alltraps>
...
80106059:	6a 4c                	push   $0x4c
  jmp alltraps
8010605b:	e9 a4 f8 ff ff       	jmp    80105904 <alltraps>
...
80106062:	6a 4d                	push   $0x4d
  jmp alltraps
80106064:	e9 9b f8 ff ff       	jmp    80105904 <alltraps>
...
8010606b:	6a 4e                	push   $0x4e
  jmp alltraps
8010606d:	e9 92 f8 ff ff       	jmp    80105904 <alltraps>
...
80106074:	6a 4f                	push   $0x4f
  jmp alltraps
80106076:	e9 89 f8 ff ff       	jmp    80105904 <alltraps>
...
8010607d:	6a 50                	push   $0x50
  jmp alltraps
8010607f:	e9 80 f8 ff ff       	jmp    80105904 <alltraps>
...
80106086:	6a 51                	push   $0x51
  jmp alltraps
80106088:	e9 77 f8 ff ff       	jmp    80105904 <alltraps>
...
8010608f:	6a 52                	push   $0x52
  jmp alltraps
80106091:	e9 6e f8 ff ff       	jmp    80105904 <alltraps>
...
80106098:	6a 53                	push   $0x53
  jmp alltraps
8010609a:	e9 65 f8 ff ff       	jmp    80105904 <alltraps>
...
801060a1:	6a 54                	push   $0x54
  jmp alltraps
801060a3:	e9 5c f8 ff ff       	jmp    80105904 <alltraps>
...
801060aa:	6a 55                	push   $0x55
  jmp alltraps
801060ac:	e9 53 f8 ff ff       	jmp    80105904 <alltraps>
...
801060b3:	6a 56                	push   $0x56
  jmp alltraps
801060b5:	e9 4a f8 ff ff       	jmp    80105904 <alltraps>
...
801060bc:	6a 57                	push   $0x57
  jmp alltraps
801060be:	e9 41 f8 ff ff       	jmp    80105904 <alltraps>
...
801060c5:	6a 58                	push   $0x58
  jmp alltraps
801060c7:	e9 38 f8 ff ff       	jmp    80105904 <alltraps>
...
801060ce:	6a 59                	push   $0x59
  jmp alltraps
801060d0:	e9 2f f8 ff ff       	jmp    80105904 <alltraps>
...
801060d7:	6a 5a                	push   $0x5a
  jmp alltraps
801060d9:	e9 26 f8 ff ff       	jmp    80105904 <alltraps>
...
801060e0:	6a 5b                	push   $0x5b
  jmp alltraps
801060e2:	e9 1d f8 ff ff       	jmp    80105904 <alltraps>
...
801060e9:	6a 5c                	push   $0x5c
  jmp alltraps
801060eb:	e9 14 f8 ff ff       	jmp    80105904 <alltraps>
...
801060f2:	6a 5d                	push   $0x5d
  jmp alltraps
801060f4:	e9 0b f8 ff ff       	jmp    80105904 <alltraps>
...
801060fb:	6a 5e                	push   $0x5e
  jmp alltraps
801060fd:	e9 02 f8 ff ff       	jmp    80105904 <alltraps>
...
80106104:	6a 5f                	push   $0x5f
  jmp alltraps
80106106:	e9 f9 f7 ff ff       	jmp    80105904 <alltraps>
...
8010610d:	6a 60                	push   $0x60
  jmp alltraps
8010610f:	e9 f0 f7 ff ff       	jmp    80105904 <alltraps>
...
80106116:	6a 61                	push   $0x61
  jmp alltraps
80106118:	e9 e7 f7 ff ff       	jmp    80105904 <alltraps>
...
8010611f:	6a 62                	push   $0x62
  jmp alltraps
80106121:	e9 de f7 ff ff       	jmp    80105904 <alltraps>
...
80106128:	6a 63                	push   $0x63
  jmp alltraps
8010612a:	e9 d5 f7 ff ff       	jmp    80105904 <alltraps>
...
80106131:	6a 64                	push   $0x64
  jmp alltraps
80106133:	e9 cc f7 ff ff       	jmp    80105904 <alltraps>
...
8010613a:	6a 65                	push   $0x65
  jmp alltraps
8010613c:	e9 c3 f7 ff ff       	jmp    80105904 <alltraps>
...
80106143:	6a 66                	push   $0x66
  jmp alltraps
80106145:	e9 ba f7 ff ff       	jmp    80105904 <alltraps>
...
8010614c:	6a 67                	push   $0x67
  jmp alltraps
8010614e:	e9 b1 f7 ff ff       	jmp    80105904 <alltraps>
...
80106155:	6a 68                	push   $0x68
  jmp alltraps
80106157:	e9 a8 f7 ff ff       	jmp    80105904 <alltraps>
...
8010615e:	6a 69                	push   $0x69
  jmp alltraps
80106160:	e9 9f f7 ff ff       	jmp    80105904 <alltraps>
...
80106167:	6a 6a                	push   $0x6a
  jmp alltraps
80106169:	e9 96 f7 ff ff       	jmp    80105904 <alltraps>
...
80106170:	6a 6b                	push   $0x6b
  jmp alltraps
80106172:	e9 8d f7 ff ff       	jmp    80105904 <alltraps>
...
80106179:	6a 6c                	push   $0x6c
  jmp alltraps
8010617b:	e9 84 f7 ff ff       	jmp    80105904 <alltraps>
...
80106182:	6a 6d                	push   $0x6d
  jmp alltraps
80106184:	e9 7b f7 ff ff       	jmp    80105904 <alltraps>
...
8010618b:	6a 6e                	push   $0x6e
  jmp alltraps
8010618d:	e9 72 f7 ff ff       	jmp    80105904 <alltraps>
...
80106194:	6a 6f                	push   $0x6f
  jmp alltraps
80106196:	e9 69 f7 ff ff       	jmp    80105904 <alltraps>
...
8010619d:	6a 70                	push   $0x70
  jmp alltraps
8010619f:	e9 60 f7 ff ff       	jmp    80105904 <alltraps>
...
801061a6:	6a 71                	push   $0x71
  jmp alltraps
801061a8:	e9 57 f7 ff ff       	jmp    80105904 <alltraps>
...
801061af:	6a 72                	push   $0x72
  jmp alltraps
801061b1:	e9 4e f7 ff ff       	jmp    80105904 <alltraps>
...
801061b8:	6a 73                	push   $0x73
  jmp alltraps
801061ba:	e9 45 f7 ff ff       	jmp    80105904 <alltraps>
...
801061c1:	6a 74                	push   $0x74
  jmp alltraps
801061c3:	e9 3c f7 ff ff       	jmp    80105904 <alltraps>
...
801061ca:	6a 75                	push   $0x75
  jmp alltraps
801061cc:	e9 33 f7 ff ff       	jmp    80105904 <alltraps>
...
801061d3:	6a 76                	push   $0x76
  jmp alltraps
801061d5:	e9 2a f7 ff ff       	jmp    80105904 <alltraps>
...
801061dc:	6a 77                	push   $0x77
  jmp alltraps
801061de:	e9 21 f7 ff ff       	jmp    80105904 <alltraps>
...
801061e5:	6a 78                	push   $0x78
  jmp alltraps
801061e7:	e9 18 f7 ff ff       	jmp    80105904 <alltraps>
...
801061ee:	6a 79                	push   $0x79
  jmp alltraps
801061f0:	e9 0f f7 ff ff       	jmp    80105904 <alltraps>
...
801061f7:	6a 7a                	push   $0x7a
  jmp alltraps
801061f9:	e9 06 f7 ff ff       	jmp    80105904 <alltraps>
...
80106200:	6a 7b                	push   $0x7b
  jmp alltraps
80106202:	e9 fd f6 ff ff       	jmp    80105904 <alltraps>
...
80106209:	6a 7c                	push   $0x7c
  jmp alltraps
8010620b:	e9 f4 f6 ff ff       	jmp    80105904 <alltraps>
...
80106212:	6a 7d                	push   $0x7d
  jmp alltraps
80106214:	e9 eb f6 ff ff       	jmp    80105904 <alltraps>
...
8010621b:	6a 7e                	push   $0x7e
  jmp alltraps
8010621d:	e9 e2 f6 ff ff       	jmp    80105904 <alltraps>
...
80106224:	6a 7f                	push   $0x7f
  jmp alltraps
80106226:	e9 d9 f6 ff ff       	jmp    80105904 <alltraps>
...
8010622d:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106232:	e9 cd f6 ff ff       	jmp    80105904 <alltraps>
...
80106239:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010623e:	e9 c1 f6 ff ff       	jmp    80105904 <alltraps>
...
80106245:	68 82 00 00 00       	push   $0x82
  jmp alltraps
8010624a:	e9 b5 f6 ff ff       	jmp    80105904 <alltraps>
...
80106251:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106256:	e9 a9 f6 ff ff       	jmp    80105904 <alltraps>
...
8010625d:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80106262:	e9 9d f6 ff ff       	jmp    80105904 <alltraps>
...
80106269:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010626e:	e9 91 f6 ff ff       	jmp    80105904 <alltraps>
...
80106275:	68 86 00 00 00       	push   $0x86
  jmp alltraps
8010627a:	e9 85 f6 ff ff       	jmp    80105904 <alltraps>
...
80106281:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106286:	e9 79 f6 ff ff       	jmp    80105904 <alltraps>
...
8010628d:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80106292:	e9 6d f6 ff ff       	jmp    80105904 <alltraps>
...
80106299:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010629e:	e9 61 f6 ff ff       	jmp    80105904 <alltraps>
...
801062a5:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801062aa:	e9 55 f6 ff ff       	jmp    80105904 <alltraps>
...
801062b1:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801062b6:	e9 49 f6 ff ff       	jmp    80105904 <alltraps>
...
801062bd:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801062c2:	e9 3d f6 ff ff       	jmp    80105904 <alltraps>
...
801062c9:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801062ce:	e9 31 f6 ff ff       	jmp    80105904 <alltraps>
...
801062d5:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801062da:	e9 25 f6 ff ff       	jmp    80105904 <alltraps>
...
801062e1:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801062e6:	e9 19 f6 ff ff       	jmp    80105904 <alltraps>
...
801062ed:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801062f2:	e9 0d f6 ff ff       	jmp    80105904 <alltraps>
...
801062f9:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801062fe:	e9 01 f6 ff ff       	jmp    80105904 <alltraps>
...
80106305:	68 92 00 00 00       	push   $0x92
  jmp alltraps
8010630a:	e9 f5 f5 ff ff       	jmp    80105904 <alltraps>
...
80106311:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106316:	e9 e9 f5 ff ff       	jmp    80105904 <alltraps>
...
8010631d:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80106322:	e9 dd f5 ff ff       	jmp    80105904 <alltraps>
...
80106329:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010632e:	e9 d1 f5 ff ff       	jmp    80105904 <alltraps>
...
80106335:	68 96 00 00 00       	push   $0x96
  jmp alltraps
8010633a:	e9 c5 f5 ff ff       	jmp    80105904 <alltraps>
...
80106341:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106346:	e9 b9 f5 ff ff       	jmp    80105904 <alltraps>
...
8010634d:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80106352:	e9 ad f5 ff ff       	jmp    80105904 <alltraps>
...
80106359:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010635e:	e9 a1 f5 ff ff       	jmp    80105904 <alltraps>
...
80106365:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
8010636a:	e9 95 f5 ff ff       	jmp    80105904 <alltraps>
...
80106371:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106376:	e9 89 f5 ff ff       	jmp    80105904 <alltraps>
...
8010637d:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80106382:	e9 7d f5 ff ff       	jmp    80105904 <alltraps>
...
80106389:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010638e:	e9 71 f5 ff ff       	jmp    80105904 <alltraps>
...
80106395:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
8010639a:	e9 65 f5 ff ff       	jmp    80105904 <alltraps>
...
801063a1:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801063a6:	e9 59 f5 ff ff       	jmp    80105904 <alltraps>
...
801063ad:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801063b2:	e9 4d f5 ff ff       	jmp    80105904 <alltraps>
...
801063b9:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801063be:	e9 41 f5 ff ff       	jmp    80105904 <alltraps>
...
801063c5:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801063ca:	e9 35 f5 ff ff       	jmp    80105904 <alltraps>
...
801063d1:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801063d6:	e9 29 f5 ff ff       	jmp    80105904 <alltraps>
...
801063dd:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801063e2:	e9 1d f5 ff ff       	jmp    80105904 <alltraps>
...
801063e9:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801063ee:	e9 11 f5 ff ff       	jmp    80105904 <alltraps>
...
801063f5:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801063fa:	e9 05 f5 ff ff       	jmp    80105904 <alltraps>
...
80106401:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106406:	e9 f9 f4 ff ff       	jmp    80105904 <alltraps>
...
8010640d:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80106412:	e9 ed f4 ff ff       	jmp    80105904 <alltraps>
...
80106419:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010641e:	e9 e1 f4 ff ff       	jmp    80105904 <alltraps>
...
80106425:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
8010642a:	e9 d5 f4 ff ff       	jmp    80105904 <alltraps>
...
80106431:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106436:	e9 c9 f4 ff ff       	jmp    80105904 <alltraps>
...
8010643d:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80106442:	e9 bd f4 ff ff       	jmp    80105904 <alltraps>
...
80106449:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010644e:	e9 b1 f4 ff ff       	jmp    80105904 <alltraps>
...
80106455:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
8010645a:	e9 a5 f4 ff ff       	jmp    80105904 <alltraps>
...
80106461:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106466:	e9 99 f4 ff ff       	jmp    80105904 <alltraps>
...
8010646d:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80106472:	e9 8d f4 ff ff       	jmp    80105904 <alltraps>
...
80106479:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010647e:	e9 81 f4 ff ff       	jmp    80105904 <alltraps>
...
80106485:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
8010648a:	e9 75 f4 ff ff       	jmp    80105904 <alltraps>
...
80106491:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106496:	e9 69 f4 ff ff       	jmp    80105904 <alltraps>
...
8010649d:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801064a2:	e9 5d f4 ff ff       	jmp    80105904 <alltraps>
...
801064a9:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801064ae:	e9 51 f4 ff ff       	jmp    80105904 <alltraps>
...
801064b5:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801064ba:	e9 45 f4 ff ff       	jmp    80105904 <alltraps>
...
801064c1:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801064c6:	e9 39 f4 ff ff       	jmp    80105904 <alltraps>
...
801064cd:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801064d2:	e9 2d f4 ff ff       	jmp    80105904 <alltraps>
...
801064d9:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801064de:	e9 21 f4 ff ff       	jmp    80105904 <alltraps>
...
801064e5:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801064ea:	e9 15 f4 ff ff       	jmp    80105904 <alltraps>
...
801064f1:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801064f6:	e9 09 f4 ff ff       	jmp    80105904 <alltraps>
...
801064fd:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80106502:	e9 fd f3 ff ff       	jmp    80105904 <alltraps>
...
80106509:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010650e:	e9 f1 f3 ff ff       	jmp    80105904 <alltraps>
...
80106515:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
8010651a:	e9 e5 f3 ff ff       	jmp    80105904 <alltraps>
...
80106521:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106526:	e9 d9 f3 ff ff       	jmp    80105904 <alltraps>
...
8010652d:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80106532:	e9 cd f3 ff ff       	jmp    80105904 <alltraps>
...
80106539:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010653e:	e9 c1 f3 ff ff       	jmp    80105904 <alltraps>
...
80106545:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
8010654a:	e9 b5 f3 ff ff       	jmp    80105904 <alltraps>
...
80106551:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106556:	e9 a9 f3 ff ff       	jmp    80105904 <alltraps>
...
8010655d:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80106562:	e9 9d f3 ff ff       	jmp    80105904 <alltraps>
...
80106569:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010656e:	e9 91 f3 ff ff       	jmp    80105904 <alltraps>
...
80106575:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
8010657a:	e9 85 f3 ff ff       	jmp    80105904 <alltraps>
...
80106581:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106586:	e9 79 f3 ff ff       	jmp    80105904 <alltraps>
...
8010658d:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80106592:	e9 6d f3 ff ff       	jmp    80105904 <alltraps>
...
80106599:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010659e:	e9 61 f3 ff ff       	jmp    80105904 <alltraps>
...
801065a5:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801065aa:	e9 55 f3 ff ff       	jmp    80105904 <alltraps>
...
801065b1:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801065b6:	e9 49 f3 ff ff       	jmp    80105904 <alltraps>
...
801065bd:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801065c2:	e9 3d f3 ff ff       	jmp    80105904 <alltraps>
...
801065c9:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801065ce:	e9 31 f3 ff ff       	jmp    80105904 <alltraps>
...
801065d5:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801065da:	e9 25 f3 ff ff       	jmp    80105904 <alltraps>
...
801065e1:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801065e6:	e9 19 f3 ff ff       	jmp    80105904 <alltraps>
...
801065ed:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801065f2:	e9 0d f3 ff ff       	jmp    80105904 <alltraps>
...
801065f9:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801065fe:	e9 01 f3 ff ff       	jmp    80105904 <alltraps>
...
80106605:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
8010660a:	e9 f5 f2 ff ff       	jmp    80105904 <alltraps>
...
80106611:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106616:	e9 e9 f2 ff ff       	jmp    80105904 <alltraps>
...
8010661d:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80106622:	e9 dd f2 ff ff       	jmp    80105904 <alltraps>
...
80106629:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010662e:	e9 d1 f2 ff ff       	jmp    80105904 <alltraps>
...
80106635:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
8010663a:	e9 c5 f2 ff ff       	jmp    80105904 <alltraps>
...
80106641:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106646:	e9 b9 f2 ff ff       	jmp    80105904 <alltraps>
...
8010664d:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80106652:	e9 ad f2 ff ff       	jmp    80105904 <alltraps>
...
80106659:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010665e:	e9 a1 f2 ff ff       	jmp    80105904 <alltraps>
...
80106665:	68 da 00 00 00       	push   $0xda
  jmp alltraps
8010666a:	e9 95 f2 ff ff       	jmp    80105904 <alltraps>
...
80106671:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106676:	e9 89 f2 ff ff       	jmp    80105904 <alltraps>
...
8010667d:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80106682:	e9 7d f2 ff ff       	jmp    80105904 <alltraps>
...
80106689:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010668e:	e9 71 f2 ff ff       	jmp    80105904 <alltraps>
...
80106695:	68 de 00 00 00       	push   $0xde
  jmp alltraps
8010669a:	e9 65 f2 ff ff       	jmp    80105904 <alltraps>
...
801066a1:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801066a6:	e9 59 f2 ff ff       	jmp    80105904 <alltraps>
...
801066ad:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801066b2:	e9 4d f2 ff ff       	jmp    80105904 <alltraps>
...
801066b9:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801066be:	e9 41 f2 ff ff       	jmp    80105904 <alltraps>
...
801066c5:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801066ca:	e9 35 f2 ff ff       	jmp    80105904 <alltraps>
...
801066d1:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801066d6:	e9 29 f2 ff ff       	jmp    80105904 <alltraps>
...
801066dd:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801066e2:	e9 1d f2 ff ff       	jmp    80105904 <alltraps>
...
801066e9:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801066ee:	e9 11 f2 ff ff       	jmp    80105904 <alltraps>
...
801066f5:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801066fa:	e9 05 f2 ff ff       	jmp    80105904 <alltraps>
...
80106701:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106706:	e9 f9 f1 ff ff       	jmp    80105904 <alltraps>
...
8010670d:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80106712:	e9 ed f1 ff ff       	jmp    80105904 <alltraps>
...
80106719:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010671e:	e9 e1 f1 ff ff       	jmp    80105904 <alltraps>
...
80106725:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
8010672a:	e9 d5 f1 ff ff       	jmp    80105904 <alltraps>
...
80106731:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106736:	e9 c9 f1 ff ff       	jmp    80105904 <alltraps>
...
8010673d:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80106742:	e9 bd f1 ff ff       	jmp    80105904 <alltraps>
...
80106749:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010674e:	e9 b1 f1 ff ff       	jmp    80105904 <alltraps>
...
80106755:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
8010675a:	e9 a5 f1 ff ff       	jmp    80105904 <alltraps>
...
80106761:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106766:	e9 99 f1 ff ff       	jmp    80105904 <alltraps>
...
8010676d:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106772:	e9 8d f1 ff ff       	jmp    80105904 <alltraps>
...
80106779:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010677e:	e9 81 f1 ff ff       	jmp    80105904 <alltraps>
...
80106785:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
8010678a:	e9 75 f1 ff ff       	jmp    80105904 <alltraps>
...
80106791:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106796:	e9 69 f1 ff ff       	jmp    80105904 <alltraps>
...
8010679d:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801067a2:	e9 5d f1 ff ff       	jmp    80105904 <alltraps>
...
801067a9:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801067ae:	e9 51 f1 ff ff       	jmp    80105904 <alltraps>
...
801067b5:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801067ba:	e9 45 f1 ff ff       	jmp    80105904 <alltraps>
...
801067c1:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801067c6:	e9 39 f1 ff ff       	jmp    80105904 <alltraps>
...
801067cd:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801067d2:	e9 2d f1 ff ff       	jmp    80105904 <alltraps>
...
801067d9:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801067de:	e9 21 f1 ff ff       	jmp    80105904 <alltraps>
...
801067e5:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801067ea:	e9 15 f1 ff ff       	jmp    80105904 <alltraps>
...
801067f1:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801067f6:	e9 09 f1 ff ff       	jmp    80105904 <alltraps>
...
801067fd:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106802:	e9 fd f0 ff ff       	jmp    80105904 <alltraps>
...
80106809:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010680e:	e9 f1 f0 ff ff       	jmp    80105904 <alltraps>
...
80106815:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
8010681a:	e9 e5 f0 ff ff       	jmp    80105904 <alltraps>
...
80106821:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106826:	e9 d9 f0 ff ff       	jmp    80105904 <alltraps>
...
8010688a:	e8 31 de ff ff       	call   801046c0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106a0e:	c7 80 18 28 11 80 ff 	movl   $0xffff,-0x7feed7e8(%eax)
80106a15:	ff 00 00 
80106a18:	c7 80 1c 28 11 80 00 	movl   $0xcf9a00,-0x7feed7e4(%eax)
80106a1f:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106a22:	c7 80 20 28 11 80 ff 	movl   $0xffff,-0x7feed7e0(%eax)
80106a29:	ff 00 00 
80106a2c:	c7 80 24 28 11 80 00 	movl   $0xcf9200,-0x7feed7dc(%eax)
80106a33:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106a36:	c7 80 28 28 11 80 ff 	movl   $0xffff,-0x7feed7d8(%eax)
80106a3d:	ff 00 00 
80106a40:	c7 80 2c 28 11 80 00 	movl   $0xcffa00,-0x7feed7d4(%eax)
80106a47:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106a4a:	c7 80 30 28 11 80 ff 	movl   $0xffff,-0x7feed7d0(%eax)
80106a51:	ff 00 00 
80106a54:	c7 80 34 28 11 80 00 	movl   $0xcff200,-0x7feed7cc(%eax)
80106a5b:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
80106a5e:	05 10 28 11 80       	add    $0x80112810,%eax
  pd[1] = (uint)p;
...
80106a84:	a1 c4 55 11 80       	mov    0x801155c4,%eax
...
80106ac8:	0f 84 c2 00 00 00    	je     80106b90 <switchuvm+0xf0>
  pushcli();
80106ace:	e8 dd d9 ff ff       	call   801044b0 <pushcli>
...
80106be3:	e8 d8 da ff ff       	call   801046c0 <memset>
...
80106c16:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106c17:	e9 44 db ff ff       	jmp    80104760 <memmove>
    panic("inituvm: more than a page");
80106c1c:	83 ec 0c             	sub    $0xc,%esp
80106c1f:	68 75 7a 10 80       	push   $0x80107a75
...
80106d4b:	e8 70 d9 ff ff       	call   801046c0 <memset>
...
80106d89:	68 ad 7a 10 80       	push   $0x80107aad
...
80106deb:	68 c5 7a 10 80       	push   $0x80107ac5
...
80106ecc:	68 e1 7a 10 80       	push   $0x80107ae1
...
80106f04:	e8 b7 d7 ff ff       	call   801046c0 <memset>
...
80106f6f:	a3 c4 55 11 80       	mov    %eax,0x801155c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106fa3:	68 f2 7a 10 80       	push   $0x80107af2
...
80106ff0:	e8 6b d7 ff ff       	call   80104760 <memmove>
...
80107089:	68 16 7b 10 80       	push   $0x80107b16
8010708e:	e8 fd 92 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80107093:	83 ec 0c             	sub    $0xc,%esp
80107096:	68 fc 7a 10 80       	push   $0x80107afc
...
8010711e:	e8 3d d6 ff ff       	call   80104760 <memmove>
    len -= n;
    buf += n;
