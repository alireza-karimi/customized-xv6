...
main(void)
{
  ...
  17:	68 00 20 00 00       	push   $0x2000
  1c:	e8 4f 07 00 00       	call   770 <malloc>
  void *stack;
  ...
  if(mod == 0){
  2e:	25 ff 0f 00 00       	and    $0xfff,%eax
  33:	0f 85 dc 00 00 00    	jne    115 <main+0x115>
  else{
  ...
  3c:	6a 02                	push   $0x2
  3e:	68 78 08 00 00       	push   $0x878
  43:	e8 8b 03 00 00       	call   3d3 <open>
  48:	83 c4 10             	add    $0x10,%esp
  4b:	85 c0                	test   %eax,%eax
  4d:	0f 88 9d 00 00 00    	js     f0 <main+0xf0>
    mknod("console", 1, 1);
    open("console", O_RDWR);
  }
  dup(0);  // stdout
  ...
  8e:	78 4d                	js     dd <main+0xdd>
      printf(1, "init: thread_create failed\n");
      exit();
    }
    if(thread_id == 0){
  90:	74 27                	je     b9 <main+0xb9>
  ...
  98:	e8 ae 03 00 00       	call   44b <join>
  9d:	85 c0                	test   %eax,%eax
  9f:	78 cf                	js     70 <main+0x70>
  a1:	39 c3                	cmp    %eax,%ebx
  a3:	74 cb                	je     70 <main+0x70>
      printf(1, "zombie!\n");
  a5:	83 ec 08             	sub    $0x8,%esp
  a8:	68 c8 08 00 00       	push   $0x8c8
  ad:	6a 01                	push   $0x1
  af:	e8 5c 04 00 00       	call   510 <printf>
  b4:	83 c4 10             	add    $0x10,%esp
  b7:	eb df                	jmp    98 <main+0x98>
      exec("sh", argv);
  b9:	50                   	push   %eax
  ba:	50                   	push   %eax
  bb:	68 98 0b 00 00       	push   $0xb98
  c0:	68 af 08 00 00       	push   $0x8af
  c5:	e8 01 03 00 00       	call   3cb <exec>
      printf(1, "init: exec sh failed\n");
  ca:	5a                   	pop    %edx
  cb:	59                   	pop    %ecx
  cc:	68 b2 08 00 00       	push   $0x8b2
  d1:	6a 01                	push   $0x1
  d3:	e8 38 04 00 00       	call   510 <printf>
      exit();
  d8:	e8 b6 02 00 00       	call   393 <exit>
      printf(1, "init: thread_create failed\n");
  dd:	53                   	push   %ebx
  de:	53                   	push   %ebx
  df:	68 93 08 00 00       	push   $0x893
  e4:	6a 01                	push   $0x1
  ...
  f1:	6a 01                	push   $0x1
  f3:	6a 01                	push   $0x1
  f5:	68 78 08 00 00       	push   $0x878
  fa:	e8 dc 02 00 00       	call   3db <mknod>
    open("console", O_RDWR);
  ff:	58                   	pop    %eax
 100:	5a                   	pop    %edx
 101:	6a 02                	push   $0x2
 103:	68 78 08 00 00       	push   $0x878
 108:	e8 c6 02 00 00       	call   3d3 <open>
 10d:	83 c4 10             	add    $0x10,%esp
 110:	e9 3e ff ff ff       	jmp    53 <main+0x53>
    stack = fptr + (PAGESIZE - mod);
 115:	29 c6                	sub    %eax,%esi
 117:	81 c6 00 10 00 00    	add    $0x1000,%esi
 11d:	e9 17 ff ff ff       	jmp    39 <main+0x39>
  }
}
 122:	8d 65 f4             	lea    -0xc(%ebp),%esp
 125:	83 c8 ff             	or     $0xffffffff,%eax
 128:	59                   	pop    %ecx
 129:	5b                   	pop    %ebx
 12a:	5e                   	pop    %esi
 12b:	5d                   	pop    %ebp
 12c:	8d 61 fc             	lea    -0x4(%ecx),%esp
 12f:	c3                   	ret    
 ...
 46c:	89 d1                	mov    %edx,%ecx
{
 ...
 499:	0f b6 92 d8 08 00 00 	movzbl 0x8d8(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 694:	eb 1a                	jmp    6b0 <printf+0x1a0>
          s = "(null)";
 696:	bb d1 08 00 00       	mov    $0x8d1,%ebx
        while(*s != 0){
