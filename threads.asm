...
int main(int argc, char *argv[]){
  ...
  1a:	e8 84 03 00 00       	call   3a3 <clone>

    if (tid < 0){
  1f:	83 c4 10             	add    $0x10,%esp
  22:	85 c0                	test   %eax,%eax
  24:	78 50                	js     76 <main+0x76>
        printf(2, "error!\n");
    }
    else if(tid == 0){
  26:	75 28                	jne    50 <main+0x50>
  ...
  30:	83 ec 0c             	sub    $0xc,%esp
            x++;
  33:	83 05 00 10 00 00 01 	addl   $0x1,0x1000
            sleep(100);
  3a:	6a 64                	push   $0x64
  3c:	e8 42 03 00 00       	call   383 <sleep>
  41:	83 c4 10             	add    $0x10,%esp
  44:	eb ea                	jmp    30 <main+0x30>
  ...
  53:	ff 35 00 10 00 00    	pushl  0x1000
  59:	68 e0 07 00 00       	push   $0x7e0
  5e:	6a 01                	push   $0x1
  60:	e8 0b 04 00 00       	call   470 <printf>
            sleep(100);
  65:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
  6c:	e8 12 03 00 00       	call   383 <sleep>
  71:	83 c4 10             	add    $0x10,%esp
  74:	eb da                	jmp    50 <main+0x50>
        printf(2, "error!\n");
  76:	50                   	push   %eax
  77:	50                   	push   %eax
  78:	68 d8 07 00 00       	push   $0x7d8
  7d:	6a 02                	push   $0x2
  7f:	e8 ec 03 00 00       	call   470 <printf>
        }
    }

  84:	8b 4d fc             	mov    -0x4(%ebp),%ecx
...
free(void *ap)
{
 ...
 645:	a1 04 10 00 00       	mov    0x1004,%eax
{
 ...
 666:	73 10                	jae    678 <free+0x38>
{
 ...
 691:	5b                   	pop    %ebx
  freep = p;
 692:	a3 04 10 00 00       	mov    %eax,0x1004
}
 697:	5e                   	pop    %esi
 698:	5f                   	pop    %edi
 699:	5d                   	pop    %ebp
 ...
 6b7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ba:	a3 04 10 00 00       	mov    %eax,0x1004
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6dd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6e0:	8b 3d 04 10 00 00    	mov    0x1004,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 729:	8b 3d 04 10 00 00    	mov    0x1004,%edi
 ...
 752:	e8 e9 fe ff ff       	call   640 <free>
  return freep;
 757:	a1 04 10 00 00       	mov    0x1004,%eax
 ...
 784:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 787:	a3 04 10 00 00       	mov    %eax,0x1004
}
 ...
 79e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7a0:	c7 05 04 10 00 00 08 	movl   $0x1008,0x1004
 7a7:	10 00 00 
    base.s.size = 0;
 7aa:	bf 08 10 00 00       	mov    $0x1008,%edi
    base.s.ptr = freep = prevp = &base;
 7af:	c7 05 08 10 00 00 08 	movl   $0x1008,0x1008
 7b6:	10 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7b9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7bb:	c7 05 0c 10 00 00 00 	movl   $0x0,0x100c
 7c2:	00 00 00 
    if(p->s.size >= nunits){
